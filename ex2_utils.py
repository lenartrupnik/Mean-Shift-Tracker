...
def show_mean_shift_progression(img, patch, patch_center, new_patch_center):
    patch_start = int(patch_center[0] - patch.shape[0] / 2), int(patch_center[1] - patch.shape[1] / 2)
    patch_end = int(patch_center[0] + patch.shape[0] / 2), int(patch_center[1] + patch.shape[1] / 2)
    
    new_patch_start = int(new_patch_center[0] - patch.shape[0] / 2), int(new_patch_center[1] - patch.shape[1] / 2)
    new_patch_end = int(new_patch_center[0] + patch.shape[0] / 2), int(new_patch_center[1] + patch.shape[1] / 2)
